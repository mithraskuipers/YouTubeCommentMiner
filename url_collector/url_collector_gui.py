...
import url_collector  # Must be in the same folder
    ...
    def run_scraper(self, query, max_results, sort_by, output_file, use_selenium, login):
        try:
            ...
            if output_file:
                ...
                final_path = url_collector.generate_output_filename(query, sort_by, max_results)

            url_collector.save_urls(urls, final_path)
